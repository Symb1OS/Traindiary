 ...
 * 
 * By Георги Костадинов, Калгари, Канада 10 October 2007 By Nedko Penev 26
 * October 2007
 * 
 * (utf-8 encoding)
 */
Ext.onReady(function() {
			...
			if (Ext.Date) {
				Ext.Date.monthNames = ["Януари", "Февруари", "Март", "Април",
				...
				Ext.Date.dayNames = ["Неделя", "Понеделник", "Вторник",
...
Ext.define("Ext.locale.bg.form.field.VTypes", {
			...
			urlText : 'Това поле трябва да бъде URL във формат "http:/'
					+ '/www.example.com"',
