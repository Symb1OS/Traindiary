 ...
 * halkon_polako 11-12-2007
 * 
 * Synchronized with 2.2 version of ext-lang-en.js (provided by Condor 8 aug
 * 2008) by halkon_polako 14-aug-2008
 */
Ext.onReady(function() {

			if (Ext.Date) {
				Ext.Date.monthNames = ["Gener", "Febrer", "Mar&#231;", "Abril",
				...
				Ext.Date.dayNames = ["Diumenge", "Dilluns", "Dimarts",
...
Ext.define("Ext.locale.ca.form.field.VTypes", {
	...
	urlText : 'Aquest camp ha de ser una URL amb el format "http:/'
			+ '/www.example.com"',
