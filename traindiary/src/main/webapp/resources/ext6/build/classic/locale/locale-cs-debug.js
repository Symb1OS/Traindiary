/**
 * Czech Translations Translated by Tomáš Korčák (72) 2008/02/08 18:02,
 * Ext-2.0.1
 */
Ext.onReady(function() {

			if (Ext.Date) {
				Ext.Date.monthNames = ["Leden", "Únor", "Březen", "Duben",
				...
				Ext.Date.dayNames = ["Neděle", "Pondělí", "Úterý", "Středa",
...
Ext.define("Ext.locale.cs.form.field.VTypes", {
	...
	urlText : 'V tomto poli může být vyplněna pouze URL (adresa internetové stránky) ve formátu "http:/'
			+ '/www.doména.cz"',
