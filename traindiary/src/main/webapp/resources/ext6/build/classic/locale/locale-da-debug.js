/**
 * Danish translation By JohnF 04-09-2007, 05:28 AM
 * 
 * Extended and modified by Karl Krukow, December, 2007.
 */
Ext.onReady(function() {

			if (Ext.Date) {
				Ext.Date.monthNames = ["januar", "februar", "marts", "april",
				...
				Ext.Date.getMonthNumber = function(name) {
					return Ext.Date.monthNumbers[name.substring(0, 3)
							.toLowerCase()];
				};
...
Ext.define("Ext.locale.da.grid.GroupingFeature", {
	...
	showGroupsText : 'Vis i grupper' // should this be sort in
		// groups?
	});
