/**
 * German translation 2007-Apr-07 update by schmidetzki and humpdi 2007-Oct-31
 * update by wm003 2009-Jul-10 update by Patrick Matsumura and Rupert Quaderer
 * 2010-Mar-10 update by Volker Grabsch
 */
Ext.onReady(function() {

			if (Ext.Date) {
				Ext.Date.monthNames = ["Januar", "Februar", "März", "April",
				...
				Ext.Date.dayNames = ["Sonntag", "Montag", "Dienstag",
...
Ext.define("Ext.locale.de.form.field.VTypes", {
	...
	urlText : 'Dieses Feld sollte eine URL enthalten. Format: "http:/'
			+ '/www.example.com"',
