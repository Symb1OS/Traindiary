/**
 * Greek translation By thesilentman (utf8 encoding) 27 Apr 2008
 * 
 * Changes since previous (second) Version: + added Ext.Date.shortMonthNames +
 * added Ext.Date.getShortMonthName + added Ext.Date.monthNumbers + added
 * Ext.grid.feature.Grouping
 */
Ext.onReady(function() {

			if (Ext.Date) {
				Ext.Date.monthNames = ["Ιανουάριος", "Φεβρουάριος", "Μάρτιος",
						"Απρίλιος", "Μάιος", "Ιούνιος", "Ιούλιος", "Αύγουστος",
						"Σεπτέμβριος", "Οκτώβριος", "Νοέμβριος", "Δεκέμβριος"];

				Ext.Date.shortMonthNames = ["Ιαν", "Φεβ", "Μάρ", "Απρ", "Μάι",
						"Ιού", "Ιού", "Αύγ", "Σεπ", "Οκτ", "Νοέ", "Δεκ"];
				...
				Ext.Date.dayNames = ["Κυριακή", "Δευτέρα", "Τρίτη", "Τετάρτη",
...
Ext.define("Ext.locale.el_GR.form.field.VTypes", {
	...
	urlText : 'Το πεδίο δέχεται μόνο URL σε μορφή "http:/'
			+ '/www.example.com"',
