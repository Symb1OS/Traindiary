/**
 * Spanish/Latin American Translation by genius551v 04-08-2007 Revised by efege,
 * 2007-04-15. Revised by Rafaga2k 10-01-2007 (mm/dd/yyyy) Revised by FeDe
 * 12-13-2007 (mm/dd/yyyy) Synchronized with 2.2 version of ext-lang-en.js
 * (provided by Condor 8 aug 2008) by halkon_polako 14-aug-2008
 */
Ext.onReady(function() {

			if (Ext.Date) {
				Ext.Date.monthNames = ["Enero", "Febrero", "Marzo", "Abril",
				...
				Ext.Date.dayNames = ["Domingo", "Lunes", "Martes", "Miércoles",
...
Ext.define("Ext.locale.es.form.field.VTypes", {
	...
	urlText : 'Este campo debe ser una URL con el formato "http:/'
			+ '/www.dominio.com"',
