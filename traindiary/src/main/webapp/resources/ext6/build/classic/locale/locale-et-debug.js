/**
 * Estonian Translations By Rene Saarsoo (2012-05-28)
 */
Ext.onReady(function() {
			...
			if (Ext.Date) {
				...
				var shortMonthNames = ["Jaan", "Veeb", "Märts", "Apr", "Mai",
...
Ext.define("Ext.locale.et.form.field.VTypes", {
	...
	urlText : 'Selle välja sisuks peab olema veebiaadress kujul "http:/'
			+ '/www.domeen.com"',
