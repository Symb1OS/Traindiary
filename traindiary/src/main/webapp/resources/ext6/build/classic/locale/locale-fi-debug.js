/**
 * Finnish Translations <tuomas.salo (at) iki.fi> 'ä' should read as lowercase
 * 'a' with two dots on top (&auml;)
 */
Ext.onReady(function() {

			if (Ext.Date) {
				Ext.Date.monthNames = ["tammikuu", "helmikuu", "maaliskuu",
				...
				Ext.Date.dayNames = ["sunnuntai", "maanantai", "tiistai",
...
Ext.define("Ext.locale.fi.form.field.VTypes", {
	...
	urlText : 'Syötä tähän kenttään URL-osoite, esim. "http:/'
			+ '/www.osoite.fi"',
