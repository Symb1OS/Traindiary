/**
 * France (France) translation By Thylia 09-11-2007, 02:22 PM updated by
 * disizben (22 Sep 2008) updated by Thylia (20 Apr 2010)
 */
Ext.onReady(function() {

			if (Ext.Date) {
				Ext.Date.shortMonthNames = ["Janv", "Févr", "Mars", "Avr",
				...
				Ext.Date.monthNames = ["Janvier", "Février", "Mars", "Avril",
				...
				Ext.Date.getMonthNumber = function(name) {
					return Ext.Date.monthNumbers[Ext.util.Format
							.capitalize(name)];
				};

				Ext.Date.dayNames = ["Dimanche", "Lundi", "Mardi", "Mercredi",
...
Ext.define("Ext.locale.fr.form.field.VTypes", {
	...
	urlText : 'Ce champ doit contenir une URL au format suivant: "http:/'
			+ '/www.example.com"',
