/**
 * Croatian translation By Ylodi (utf8 encoding) 8 May 2007
 * 
 * By Stjepan at gmail dot com (utf8 encoding) 17 May 2008
 */
Ext.onReady(function() {

			if (Ext.Date) {
				Ext.Date.monthNames = ["Siječanj", "Veljača", "Ožujak",
				...
				Ext.Date.dayNames = ["Nedjelja", "Ponedjeljak", "Utorak",
...
Ext.define("Ext.locale.hr.form.field.VTypes", {
	...
	urlText : 'Ovdje možete unijeti samo URL u obliku "http:/'
			+ '/www.domena.com"',
