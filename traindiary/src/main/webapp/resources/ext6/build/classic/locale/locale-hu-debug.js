 ...
 * 
 * Hungarian Translations (utf-8 encoded) by Amon <amon@theba.hu> (27 Apr 2008)
 * encoding fixed by Vili (17 Feb 2009)
 */
Ext.onReady(function() {

			if (Ext.Date) {
				Ext.Date.monthNames = ["Január", "Február", "Március",
				...
				Ext.Date.dayNames = ["Vasárnap", "Hétfő", "Kedd", "Szerda",
...
Ext.define("Ext.locale.hu.form.field.VTypes", {
	...
	urlText : 'A mező webcímet tartalmazhat, melynek formátuma "http:/'
			+ '/www.weboldal.hu"',
