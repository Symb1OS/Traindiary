/**
 * Italian translation 28 Maggio 2012 updated by Fabio De Paolis (many changes,
 * update to 4.1.0) 21 Dicembre 2007 updated by Federico Grilli 04 Ottobre 2007
 * updated by eric_void
 */
Ext.onReady(function() {

			if (Ext.Date) {
				Ext.Date.monthNames = ["Gennaio", "Febbraio", "Marzo",
				...
				Ext.Date.dayNames = ["Domenica", "Lunedi", "Martedi",
...
Ext.define("Ext.locale.it.form.field.VTypes", {
	...
	urlText : 'Il campo deve essere un indirizzo web nel formato "http:/'
			+ '/www.esempio.com"',
