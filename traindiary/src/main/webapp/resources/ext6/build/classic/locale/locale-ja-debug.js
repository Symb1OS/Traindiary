/**
 * Japanese translation By tyama 04-08-2007, 05:49 AM
 * 
 * update based on English Translations by Condor (8 Aug 2008) By sakuro (30 Aug
 * 2008)
 */
Ext.onReady(function() {
			...
			if (Ext.Date) {
				...
				Ext.Date.getMonthNumber = function(name) {
					return Ext.Date.monthNumbers[name.substring(0, name.length
									- 1)];
					// or simply parseInt(name.substring(0, name.length - 1)) -
					// 1
				};

				Ext.Date.dayNames = ["日曜日", "月曜日", "火曜日", "水曜日", "木曜日", "金曜日",
						"土曜日"];

				Ext.Date.getShortDayName = function(day) {
					return Ext.Date.dayNames[day].substring(0, 1); // just
					// remove
					// "曜日"
					// suffix
				};
				...
				Ext.Date.formatCodes.A = "(this.getHours() < 12 ? '午前' : '午後')"; // no
				// case
				// difference
