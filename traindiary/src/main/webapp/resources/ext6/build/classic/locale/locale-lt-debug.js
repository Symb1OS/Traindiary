/**
 * Lithuanian Translations (UTF-8) Vladas Saulis (vladas at prodata dot lt),
 * 03-29-2009 Vladas Saulis (vladas at prodata dot lt), 10-18-2007
 */
Ext.onReady(function() {

	if (Ext.Date) {
		Ext.Date.monthNames = ["Sausis", "Vasaris", "Kovas", "Balandis",
		...
		Ext.Date.dayNames = ["Sekmadienis", "Pirmadienis", "Antradienis",
...
Ext.define("Ext.locale.lt.form.field.VTypes", {
	...
	urlText : 'Šiame lauke turi būti nuoroda (URL) formatu "http:/'
			+ '/www.example.com"',
