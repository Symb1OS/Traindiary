/**
 * Macedonia translation By PetarD petar.dimitrijevic@vorteksed.com.mk (utf8
 * encoding) 23 April 2007
 */
Ext.onReady(function() {

			if (Ext.Date) {
				Ext.Date.monthNames = ["Јануари", "Февруари", "Март", "Април",
						"Мај", "Јуни", "Јули", "Август", "Септември",
						"Октомври", "Ноември", "Декември"];

				Ext.Date.dayNames = ["Недела", "Понеделник", "Вторник",
...
Ext.define("Ext.locale.mk.form.field.VTypes", {
	...
	urlText : 'Ова поле треба да биде URL во формат "http:/'
			+ '/www.example.com"',
