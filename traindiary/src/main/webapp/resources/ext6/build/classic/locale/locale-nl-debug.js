 ...
 * 
 * Dutch Translations by Ido Sebastiaan Bas van Oostveen (12 Oct 2007) updated
 * to 2.2 by Condor (8 Aug 2008)
 */
Ext.onReady(function() {

			if (Ext.Date) {
				Ext.Date.monthNames = ['januari', 'februari', 'maart', 'april',
				...
				Ext.Date.dayNames = ['zondag', 'maandag', 'dinsdag',
...
Ext.define("Ext.locale.nl.form.field.VTypes", {
	...
	urlText : 'Dit veld moet een URL bevatten in het formaat "http:/'
			+ '/www.domein.nl"',
