...
Ext.onReady(function() {
			...
			if (Ext.Date) {
				Ext.Date.monthNames = ["Januar", "Februar", "Mars", "April",
				...
				Ext.Date.dayNames = ["Søndag", "Måndag", "Tysdag", "Onsdag",
...
Ext.define("Ext.locale.no_NN.form.field.VTypes", {
	...
	urlText : 'Dette feltet skal vere ein link (URL) på formatet "http:/'
			+ '/www.domene.no"',
