/**
 * Polish Translations By vbert 17-April-2007 Updated by mmar 16-November-2007
 * Encoding: utf-8
 */
Ext.onReady(function() {

			if (Ext.Date) {
				Ext.Date.monthNames = ["Styczeń", "Luty", "Marzec", "Kwiecień",
				...
				Ext.Date.dayNames = ["Niedziela", "Poniedziałek", "Wtorek",
...
Ext.define("Ext.locale.pl.form.field.VTypes", {
	...
	urlText : 'To pole wymaga podania adresu strony www w formacie: "http:/'
			+ '/www.domena.pl"',
