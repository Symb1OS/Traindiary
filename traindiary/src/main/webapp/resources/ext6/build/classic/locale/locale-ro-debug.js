/**
 * Romanian translations for ExtJS 2.1 First released by Lucian Lature on
 * 2007-04-24 Changed locale for Romania (date formats) as suggested by keypoint
 * on ExtJS forums:
 * http://www.extjs.com/forum/showthread.php?p=129524#post129524 Removed some
 * useless parts Changed by: Emil Cazamir, 2008-04-24 Fixed some errors left
 * behind Changed by: Emil Cazamir, 2008-09-01
 */
Ext.onReady(function() {

			if (Ext.Date) {
				Ext.Date.monthNames = ["Ianuarie", "Februarie", "Martie",
				...
				Ext.Date.getMonthNumber = function(name) {
					return Ext.Date.monthNumbers[name.substring(0, 1)
							.toUpperCase()
							+ name.substring(1, 3).toLowerCase()];
				};

				Ext.Date.dayNames = ["Duminică", "Luni", "Marţi", "Miercuri",
						"Joi", "Vineri", "Sâmbătă"];
...
Ext.define("Ext.locale.ro.form.field.VTypes", {
	...
	urlText : 'Acest câmp trebuie să conţină o adresă URL în formatul "http:/'
			+ '/www.domeniu.com"',
