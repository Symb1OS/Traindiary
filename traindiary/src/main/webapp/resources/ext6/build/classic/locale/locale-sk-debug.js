/**
 * List compiled by mystix on the extjs.com forums. Thank you Mystix! Slovak
 * Translation by Michal Thomka 14 April 2007
 */
Ext.onReady(function() {

			if (Ext.Date) {
				Ext.Date.monthNames = ["Január", "Február", "Marec", "Apríl",
						"Máj", "Jún", "Júl", "August", "September", "Október",
						"November", "December"];

				Ext.Date.dayNames = ["Nedeľa", "Pondelok", "Utorok", "Streda",
