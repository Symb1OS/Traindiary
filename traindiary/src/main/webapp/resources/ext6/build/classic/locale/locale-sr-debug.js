/**
 * Serbian Latin Translation by Atila Hajnal (latin, utf8 encoding) sr 14 Sep
 * 2007
 */
Ext.onReady(function() {

			if (Ext.Date) {
				Ext.Date.monthNames = ["Januar", "Februar", "Mart", "April",
						"Мај", "Jun", "Јul", "Avgust", "Septembar", "Oktobar",
						"Novembar", "Decembar"];

				Ext.Date.dayNames = ["Nedelja", "Ponedeljak", "Utorak",
...
Ext.define("Ext.locale.sr.form.field.VTypes", {
	...
	urlText : 'Ovo polje prihavata URL adresu isključivo u obliku "http:/'
			+ '/www.domen.com"',
