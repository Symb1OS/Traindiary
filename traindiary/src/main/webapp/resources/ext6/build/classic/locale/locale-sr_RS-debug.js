/**
 * Serbian Cyrillic Translation by Čolovic Vladan (cyrillic, utf8 encoding)
 * sr_RS (ex: sr_CS, sr_YU) 12 May 2007
 */
Ext.onReady(function() {

			if (Ext.Date) {
				Ext.Date.monthNames = ["Јануар", "Фебруар", "Март", "Април",
						"Мај", "Јун", "Јул", "Август", "Септембар", "Октобар",
						"Новембар", "Децембар"];

				Ext.Date.dayNames = ["Недеља", "Понедељак", "Уторак", "Среда",
...
Ext.define("Ext.locale.sr_RS.form.field.VTypes", {
	...
	urlText : 'Ово поље прихвата URL адресу искључиво у облику "http:/'
			+ '/www.domen.com"',
