 ...
 * 
 * Original translation by zlatko 3 October 2007
 * 
 * Updated by dev.ashevchuk@gmail.com 01.09.2009
 */
Ext.onReady(function() {

			if (Ext.Date) {
				Ext.Date.monthNames = ["Січень", "Лютий", "Березень",
						"Квітень", "Травень", "Червень", "Липень", "Серпень",
						"Вересень", "Жовтень", "Листопад", "Грудень"];

				Ext.Date.dayNames = ["Неділя", "Понеділок", "Вівторок",
...
Ext.define("Ext.locale.ukr.form.field.VTypes", {
	...
	urlText : 'Це поле повинно містити URL у форматі "http:/'
			+ '/www.example.com"',
