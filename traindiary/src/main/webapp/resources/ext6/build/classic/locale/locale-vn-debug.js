/**
 * List compiled by mystix on the extjs.com forums. Thank you Mystix! Vietnamese
 * translation By bpmtri 12-April-2007 04:06PM
 */
Ext.onReady(function() {

			if (Ext.Date) {
				Ext.Date.monthNames = ["Tháng 1", "Tháng 2", "Tháng 3",
						"Tháng 4", "Tháng 5", "Tháng 6", "Tháng 7", "Tháng 8",
						"Tháng 9", "Tháng 10", "Tháng 11", "Tháng 12"];

				Ext.Date.dayNames = ["Chủ nhật", "Thứ hai", "Thứ ba", "Thứ tư",
...
Ext.define("Ext.locale.vn.form.field.VTypes", {
	...
	urlText : 'Giá trị của ô này phải là một địa chỉ web(URL) hợp lệ, có dạng như "http:/'
			+ '/www.example.com"',
