...
Ext.define("Ext.theme.neptune.layout.component.Dock", {
	...
	noBorderClassTable : [0, Ext.baseCSSPrefix + "noborder-l",
	...
	onRemove : function(d) {
		var c = this, b = d.lastBorderMask, a = d.lastBorderCollapse;
	...
	Ext.define("Ext.theme.triton.menu.Item", {
				...
				privates : {
					repaintIcons : function() {
						var c = this.iconEl, b = this.arrowEl, a = this.checkEl;
						if (c) {
							c.syncRepaint()
						}
						if (b) {
