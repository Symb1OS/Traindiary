Ext.define('Pandora.controller.Song', {
			...
			onRecentSongsLoad : function(songs, request) {
				var store = this.getRecentSongsStore(), selModel = this
						.getRecentlyPlayedScroller().getSelectionModel();

				// The data should already be filtered on the serverside but
				// since we
				// are loading static data we need to do this after we loaded
				// all the data
