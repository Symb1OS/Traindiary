/**
 * Books controller Used to manage books; showing the first book, showing a
 * spefied book, loading books, and showing their related views
 */
Ext.define('Books.controller.Books', {
			...
			/**
			 * Called when the books store is loaded. Checks if there are any
			 * records, and if there are, it delegates to show the first record
			...
			onBooksStoreLoad : function(store, records) {
				Ext.defer(function() {
							if (records.length) {
								...
								me.getBookSideBar().getSelectionModel()
										.select(record);
							}
						}, 500, this);
			},
