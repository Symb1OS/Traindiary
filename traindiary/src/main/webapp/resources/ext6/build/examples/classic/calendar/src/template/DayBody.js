 ...
 *          <p>
 *          This is the template used to render the scrolling body container
 *          used in {@link Ext.calendar.DayView DayView} and
 *          {@link Ext.calendar.WeekView WeekView}. This template is
 *          automatically bound to the underlying event store by the calendar
 *          components and expects records of type
 ...
 *          {@link Ext.calendar.DayHeaderTemplate}.
 *          </p>
 * @constructor
 * @param {Object}
...
Ext.define('Ext.calendar.template.DayBody', {
	...
	applyTemplate : function(o) {
		...
		var i = 0, days = [], dt = Ext.Date.clone(o.viewStart), times = [];
		...
		// use a fixed DST-safe date so times don't get skipped on DST
		// boundaries
