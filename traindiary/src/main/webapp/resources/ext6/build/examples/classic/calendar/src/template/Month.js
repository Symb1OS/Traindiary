 ...
 *          <p>
 *          This is the template used to render the
 *          {@link Ext.calendar.template.Month MonthView}. Internally this
 *          class defers to an instance of
 *          {@link Ext.calerndar.BoxLayoutTemplate} to handle the inner layout
 *          rendering and adds containing elements around that to form the month
 *          view.
 *          </p>
 *          <p>
...
Ext.define('Ext.calendar.template.Month', {
	...
	constructor : function(config) {
		...
		var weekLinkTpl = this.showWeekLinks
				? '<div class="ext-cal-week-link-hd">&#160;</div>'
				: '';
	...
	applyTemplate : function(o) {
		var days = [], weeks = this.weekTpl.apply(o), dt = o.viewStart, D = Ext.calendar.util.Date;
