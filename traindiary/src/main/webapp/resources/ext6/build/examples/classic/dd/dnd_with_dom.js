Ext.onReady(function() {
	// Create an object that we'll use to implement and override drag behaviors
	// a little later
	var overrides = {
		...
		endDrag : function() {
			...
			if (this.invalidDrop === true) {
				...
				this.el.setXY([this.originalXY[0], this.originalXY[1]],
						animCfgObj);
	...
	Ext.each(carElements.elements, function(el) {
				...
				// Apply the overrides object to the newly created instance of
				// DD
	...
	// Instantiate instances of Ext.dd.DDTarget for the cars and trucks
	// container
	var carsDDTarget = Ext.create('Ext.dd.DDTarget', 'cars', 'carsDDGroup');
	var trucksDDTarget = Ext.create('Ext.dd.DDTarget', 'trucks',
			'trucksDDGroup');

	// Instantiate instnaces of DDTarget for the rented and repair drop target
	// elements
	...
	// Ensure that the rented and repair DDTargets will participate in the
	// trucksDDGroup
