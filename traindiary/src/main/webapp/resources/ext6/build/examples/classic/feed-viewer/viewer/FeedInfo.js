 ...
 * 
 * @constructor Create a new Feed Info
 * @param {Object}
...
Ext.define('FeedViewer.FeedInfo', {
			 ...
			 * 
			 * @private
			 * @param {FeedViewer.FeedPost}
			 *            post The post
			 * @param {Ext.data.Model}
			 *            rec The model instance
			 */
			 ...
			 * @return {Ext.Component} The panel matching the title. null if not
			 *         found.
			 */
