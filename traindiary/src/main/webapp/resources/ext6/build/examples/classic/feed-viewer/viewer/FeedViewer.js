 ...
 * 
 * @constructor Create a new Feed Viewer app
 * @param {Object}
	...
	initComponent : function() {
		...
		Ext.define('FeedItem', {
					...
					fields : [{
								...
								// Some feeds return the description as the main
								// content
								// Others return description as a summary.
								// Figure this out here
								name : 'description',
								mapping : function(raw) {
									var DQ = Ext.dom.Query, content = DQ
											.selectNode('content', raw), key;
								...
								mapping : function(raw) {
									var DQ = Ext.dom.Query, content = DQ
											.selectNode('content', raw);

									if (!content || !DQ.getNodeValue(content)) {
										content = DQ.selectNode('description',
												raw);
									}
