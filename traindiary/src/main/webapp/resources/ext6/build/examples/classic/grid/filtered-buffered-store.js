...
Ext.onReady(function() {
	...
	var store = Ext.create('Ext.data.BufferedStore', {
				...
				// The topics-remote.php script appears to be hardcoded to use
				// 50, and ignores this parameter, so we
				// are forced to use 50 here instead of a possibly more
				// efficient value.
				pageSize : 50,

				// This web service seems slow, so keep lots of data in the
				// pipeline ahead!
				leadingBufferZone : 1000,
				proxy : {
					// load using script tags for cross domain, if the data in
					// on the same domain as
