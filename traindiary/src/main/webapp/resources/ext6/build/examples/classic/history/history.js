...
Ext.onReady(function() {
	...
	// Needed if you want to handle history for multiple components in the same
	// page.
	...
	// Handle this change event in order to restore the UI to the appropriate
	// history state
	function onAfterRender() {
		...
		// from the
		// page without any existing history token params and go back to the
		// start state.
		var activeTab1 = Ext.getCmp('main-tabs').getActiveTab(), activeTab2 = activeTab1
				.getActiveTab();
