Ext.require(['Ext.form.Panel', 'Ext.ux.form.MultiSelect',
		'Ext.ux.form.ItemSelector', 'Ext.tip.QuickTipManager',
		'Ext.ux.ajax.JsonSimlet', 'Ext.ux.ajax.SimManager']);
...
Ext.onReady(function() {
			...
			items : {
				...
				menu : [{
					...
					handler : function() {
						...
						Ext.Msg.alert('Value is a split array', value
										.join(', '));
					}
				}, {
					text : 'Set value (2,3)',
					...
					checkHandler : function(item, checked) {
						...
						if (checked) {
							...
							Ext.Msg
									.alert(
											'Delimiter Changed',
											'The delimiter is now set to <b>","</b>. Click Save to '
							...
							Ext.Msg
									.alert(
											'Delimiter Changed',
											'The delimiter is now set to <b>null</b>. Click Save to '
	...
	Ext.ux.ajax.SimManager.init({
		...
		'Numbers' : {
			data : [[123, 'One Hundred Twenty Three'], ['1', 'One'],
