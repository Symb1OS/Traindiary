...
Ext.define('Ext.App', {
	...
	/**
	 * @cfg {Object} api remoting api. should be defined in your own config js.
	 */
	api : {
		url : null,
		type : null,
	...
	/**
	 * registerView register an application view component.
	 * 
	 * @param {Object}
	 *            view
	 */
	...
	/**
	 * getViews return list of registered views
	 */
	getViews : function() {
		return this.views;
	},
	...
	/**
	 * registerActions registers new actions for API
	 * 
	 * @param {Object}
	 *            actions
	 */
	...
	/**
	 * getAPI return Ext Remoting api
	 */
	getAPI : function() {
		return this.api;
	},
	...
	addMessage : function(status, msg) {
		...
		// Ensure message container is last in the DOM so it cannot interfere
		// with
	...
	/**
	 * t translation function. needs to be implemented. simply echos supplied
	 * word back currently.
	 * 
	 * @param {String}
	 *            to translate
