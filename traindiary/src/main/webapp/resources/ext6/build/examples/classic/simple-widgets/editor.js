...
Ext.onReady(function() {
	var isLargeTheme = Ext.themeName !== 'classic', titleOffset = isLargeTheme
			? -6
			: -4;
				...
				listeners : {
					afterrender : function(form) {
						...
						form.getTargetEl().on('dblclick', function(e, t) {
									...
									// Manually focus, since clicking on the
									// label will focus the text field
						...
						form.header.getTitle().textEl.on('dblclick', function(
										e, t) {
