Ext.require(['Ext.grid.*', 'Ext.window.Window', 'Ext.container.Viewport',
		'Ext.layout.container.Border', 'Ext.state.*', 'Ext.data.*']);
...
Ext.onReady(function() {
	...
	Ext.create('Ext.container.Viewport', {
		...
		items : [{
			...
			split : true,
			collapsible : true,
			html : ['Between refreshes, this panel will remember:', '<ul>',
					'<li>The collapsed state</li>', '<li>The width</li>',
					'</ul>'].join('')
		}, {
			region : 'center',
			stateful : true,
