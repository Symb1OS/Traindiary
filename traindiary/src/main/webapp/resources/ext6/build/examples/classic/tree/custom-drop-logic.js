Ext.require(['Ext.tree.*', 'Ext.data.*', 'Ext.layout.container.HBox',
					...
					viewConfig : {
						...
						listeners : {
							nodedragover : function(targetNode, position,
									dragData) {
								var rec = dragData.records[0], isFirst = targetNode
										.isFirst(), canDropFirst = rec
										.get('canDropOnFirst'), canDropSecond = rec
										.get('canDropOnSecond');
