...
Ext.define('Ext.chooser.Window', {
	...
	/**
	 * @event selected Fired whenever the user selects an image by double
	 *        clicked it or clicking the window's OK button
	...
	initComponent : function() {
		this.items = [{
					...
					tbar : [{
								...
								// Use non-breaking space so that labelWidth of
								// null shrinkwraps the unbroken string width
								fieldLabel : 'Sort\u00a0By',
								labelWidth : null,
								valueField : 'field',
								displayField : 'label',
	...
	filter : function(field, newValue) {
		var view = this.down('iconbrowser'), store = view.getStore(), selModel = view
