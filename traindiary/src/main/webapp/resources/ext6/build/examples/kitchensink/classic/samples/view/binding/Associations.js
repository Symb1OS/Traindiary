/**
 * This example shows simple association binding. The orders grid is bound to
 * the orders of the selected customer. The binding statement is able to
 * interpret that orders is an association and can show the orders for our
 * customer.
 */
