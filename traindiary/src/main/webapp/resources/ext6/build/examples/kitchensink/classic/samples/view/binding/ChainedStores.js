/**
 * This example demonstrates a chained store, a store that is backed by the data
 * of another store. Sorting and filtering of the stores are independent.
 * Removing a value in the source store removes it from the chained store. Model
 * instances are shared, so editing the data in one store will be reflected in
 * the other.
 */
Ext.define('KitchenSink.view.binding.ChainedStores', {
	...
	// <example>
	requires : ['Ext.layout.container.VBox', 'Ext.layout.container.HBox',
			'Ext.grid.Panel', 'KitchenSink.model.Person',
