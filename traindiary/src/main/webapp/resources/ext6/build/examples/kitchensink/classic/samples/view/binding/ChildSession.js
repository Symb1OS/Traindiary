 ...
 * created, a child session is spawned from the parent. Any changes made to data
 * in this session do not affect the parent immediately. The changes are kept
 * separate from the parent and may then be saved to the parent or alternatively
 * discarded to leave the parent in its original state.
 */
Ext.define('KitchenSink.view.binding.ChildSession', {
	extend : 'Ext.panel.Panel',
	xtype : 'binding-child-session',
	// <example>
	requires : ['KitchenSink.view.binding.ChildSessionModel',
			'KitchenSink.view.binding.ChildSessionController', 'Ext.grid.Panel'],
	otherContent : [{
				type : 'ViewModel',
