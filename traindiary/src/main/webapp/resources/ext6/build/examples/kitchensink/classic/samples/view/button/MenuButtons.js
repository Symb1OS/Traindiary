/**
 * This example shows how to create menu buttons. Menu buttons have a dropdown
 * arrow and display a menu when clicked. A standard button can be turned into a
 * menu button simply by adding the `menu` config.
 */
