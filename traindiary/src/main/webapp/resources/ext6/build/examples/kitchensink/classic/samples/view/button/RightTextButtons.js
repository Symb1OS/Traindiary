/**
 * This example shows how to align button text to the right. By default, buttons
 * are sized to the width of the text inside them, but this behavior can be
 * overridden by giving the button a fixed width. In such a case the alignment
 * of the text can be controlled using the `textAlign` config.
 */
