/**
 * This example demonstrates the use of split buttons. A split button is similar
 * to a menu button, but its arrow can fire an event separately from the default
 * click event of the button. This event would typically be used to display a
 * dropdown menu, but can also be used to attach a custom action.
 */
