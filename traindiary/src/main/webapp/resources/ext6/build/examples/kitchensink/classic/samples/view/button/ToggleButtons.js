/**
 * This example demonstrates the use of toggle buttons. Toggle buttons are just
 * like normal buttons except that they have two states - pressed and unpressed.
 * Toggling can be enabled by setting the `enableToggle` config to `true` on a
 * standard button.
 */
