Ext.define('KitchenSink.view.charts.area.BasicController', {
			...
			onAxisLabelRender : function(axis, label, layoutContext) {
				...
				// don't want to loose the formatting done by the native
				// renderer,
				...
				return {
					...
					tooltip : {
						...
						renderer : function(tooltip, record, item) {
							tooltip.setHtml(title + ' (' + record.get('year')
									+ '): ' + record.get(field));
						}
					}
				};
			...
			onAfterRender : function() {
				var me = this, chart = me.lookupReference('chart');

				chart.setSeries([me.getSeriesConfig('usa', 'USA'),
