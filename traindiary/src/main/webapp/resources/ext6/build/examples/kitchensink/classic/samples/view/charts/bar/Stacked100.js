/**
 * 100% stacked bars are bar charts where categories are stacked on top of each
 * other. The value of each category is recalculated so that it represents a
 * share of the whole, which is the full stack and is equal to 100 by default.
 */
