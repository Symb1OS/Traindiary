/**
 * A basic 3D bar chart is a chart with horizontal bars of lengths proportional
 * to the magnitudes of the data it represents. Basic 3D bars can be used in the
 * same manner as the 3D column charts. Categories are typically organized along
 * the vertical axis and values along the horizontal axis. Tapping or hovering a
 * bar will highlight it.
 */
