Ext.define('KitchenSink.view.charts.column.StackedController', {
	...
	onEditTipRender : function(tooltip, item, target, e) {
		var fieldIndex = Ext.Array.indexOf(item.series.getYField(),
				target.yField), browser = item.series.getTitle()[fieldIndex];

		tooltip.setHtml(browser + ' on ' + item.record.get('month') + ': '
