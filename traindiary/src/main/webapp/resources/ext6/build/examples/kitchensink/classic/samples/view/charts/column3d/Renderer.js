/**
 * This example shows how to use a 3D column chart with a renderer to alter the
 * look of individual columns in the series based on certain criteria (in this
 * case column index).
 */
