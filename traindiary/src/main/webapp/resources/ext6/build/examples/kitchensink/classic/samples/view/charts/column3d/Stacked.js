/**
 * Stacked 3D columns are column charts where categories are stacked on top of
 * each other. This is typically done to visually represent the total of all
 * categories for a given period or value.
 */
Ext.define('KitchenSink.view.charts.column3d.Stacked', {
	...
	requires : ['Ext.chart.CartesianChart', 'Ext.chart.axis.Numeric',
			'Ext.chart.axis.Time', 'Ext.draw.modifier.Highlight',
			'Ext.chart.interactions.ItemHighlight', 'Ext.chart.theme.*'],
