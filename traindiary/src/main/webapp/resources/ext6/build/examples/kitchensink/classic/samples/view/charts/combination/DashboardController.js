Ext.define('KitchenSink.view.charts.combination.DashboardController', {
	...
	highlightCompanyPriceBar : function(record) {
		var barChart = this.lookupReference('barChart'), store = barChart
				.getStore(), series = barChart.getSeries()[0], name = record
				.get('name');
	...
	onAfterRender : function() {
		var barChart = this.lookupReference('barChart'), gridPanel = this
				.lookupReference('gridPanel');
