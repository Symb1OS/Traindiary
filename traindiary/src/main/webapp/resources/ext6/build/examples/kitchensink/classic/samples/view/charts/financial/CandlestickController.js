Ext.define('KitchenSink.view.charts.financial.CandlestickController', {
	...
	onModeToggle : function(segmentedButton, button, pressed) {
		var chart = this.lookupReference('chart'), interactions = chart
				.getInteractions(), panzoom = interactions[0], crosshair = interactions[1], value = segmentedButton
				.getValue(), isCrosshair = value === 0;
	...
	onPanZoomReset : function() {
		var chart = this.lookupReference('chart'), axes = chart.getAxes();
