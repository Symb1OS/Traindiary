/**
 * Marked splines are multi-series splines displaying smooth curves across
 * multiple categories. Markers are placed at each connected point to clearly
 * depict their position.
 */
Ext.define('KitchenSink.view.charts.line.MarkedSpline', {
	...
	items : [{
		...
		axes : [{
					...
					style : {
						textPadding : 0
						// remove extra padding between labels to make sure no
						// labels are skipped
					},
					grid : true,
					label : {
