Ext.define('KitchenSink.view.charts.scatter.BasicController', {
			...
			onAfterRender : function() {
				var chart = this.lookupReference('chart'), panzoom = chart
						.getInteractions()[0], toolbar = this
						.lookupReference('toolbar');

				toolbar.add(panzoom.getModeToggleButton());
			},

			onPanZoomReset : function() {
				var chart = this.lookupReference('chart'), axes = chart
						.getAxes();
