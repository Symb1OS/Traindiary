 ...
 * 
 * Bubble charts, similarly to Line charts, allow to visualize the evolution of
 * a parameter over time or the ratio between any two parameters, but in
 * addition they can also display intrinsic values of these parameters by
 * assigning them to the diameter or the color of the bubbles.
 */
Ext.define('KitchenSink.view.charts.scatter.Bubble', {
	...
	requires : ['Ext.draw.Color', 'Ext.chart.CartesianChart',
			'Ext.chart.series.Scatter', 'Ext.chart.axis.Numeric',
