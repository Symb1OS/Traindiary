 ...
 * 
 * We're also using the reorderable toolbar plugin to make it easy to reorder
 * the sorters with drag and drop. To change the sort order, just drag and drop
 * the "Type" or "Name" field.
 */
Ext.define('KitchenSink.view.dataview.MultiSort', {
	...
	/**
	 * Returns the array of Ext.util.Sorters defined by the current toolbar
	 * button order
	 * 
