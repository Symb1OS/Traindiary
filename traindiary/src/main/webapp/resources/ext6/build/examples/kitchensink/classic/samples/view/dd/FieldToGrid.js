 ...
 * 
 * Fields are editable. Drag the fields into the grid using the label as the
 * handle.
 */
Ext.define('KitchenSink.view.dd.FieldToGrid', {
	extend : 'Ext.container.Container',

	requires : ['Ext.ux.dd.CellFieldDropZone', 'Ext.ux.dd.PanelFieldDragZone',
			'Ext.grid.*', 'Ext.form.*', 'KitchenSink.model.Company',
