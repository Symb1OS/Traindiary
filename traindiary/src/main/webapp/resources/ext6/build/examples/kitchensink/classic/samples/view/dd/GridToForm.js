/**
 * This example shows how to setup a one way drag and drop from a Grid to a
 * Panel.
 */
Ext.define('KitchenSink.view.dd.GridToForm', {
			extend : 'Ext.container.Container',

			requires : ['Ext.grid.*', 'Ext.form.*',
					'Ext.layout.container.HBox', 'Ext.dd.DropTarget',
			...
			onBoxReady : function() {
				...
				this.formPanelDropTarget = new Ext.dd.DropTarget(body, {
							...
							notifyDrop : function(ddSource, e, data) {
								// Reference the record (single selection) for
								// readability
								...
								// Delete record from the source store. not
								// really required.
