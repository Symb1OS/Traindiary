/**
 * This abstract ViewController implements certain methods shared by all
 * ViewControllers in Ext Direct examples.
 */
Ext.define('KitchenSink.view.direct.DirectVC', {
			...
			config : {
				/**
				 * @cfg {String} url The URL to use for Ext Direct service
				 *      discovery requests.
				 */
				apiUrl : undefined,

				/**
				 * @cfg {Object} [providerCfg] Optional configuration object to
				 *      apply to Provider declaration before it is created.
				 */
			...
			destroy : function() {
				var me = this, providerUrls = me.providerUrls, i, len, url;

				// Notify the Direct controller that we no longer need our
				// provider(s)
			 ...
			 * derived ViewControllers should override it to finish
			 * initialization.
			 * 
			 * @template
			 * @protected
