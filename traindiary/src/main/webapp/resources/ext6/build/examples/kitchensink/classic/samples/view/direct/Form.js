...
Ext.define('KitchenSink.view.direct.Form', {
	...
	items : [{
				...
				api : {
					// Note that the method names are quoted in all forms of
					// this
					// example. This makes use of thelazy method resolution
					// feature
					// that is built in Ext.Direct form actions, as well as
					// Direct
					// data proxy. When KitchenSink.view.direct.Form class is
					// defined
					// upon initial application load, the Profile.getPhoneInfo
					// function does not exist yet; it will be created later
					// when
					// Form API is received from the server and Form Provider is
					// created. By quoting the function name we are deferring
					// function resolution until the time it is first used,
					// which
					// happens when the form is loaded. Form loading in turn is
					// initiated from the Form ViewController that will
					// initialize
