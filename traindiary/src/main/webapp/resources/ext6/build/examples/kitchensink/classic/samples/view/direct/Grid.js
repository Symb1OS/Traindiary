/**
 * This example shows how to use a Grid with a back end Store via Ext.Direct
 * proxy.
 * 
 * The grid will be populated with the data queried from a virtual "table"
 * hardcoded in the PHP script that handles the requests; sorting is also
 * performed remotely.
 */
Ext.define('KitchenSink.view.direct.Grid', {
	...
	requires : ['KitchenSink.view.direct.GridController'],
