/**
 * This example shows how to use a Tree with nodes loaded dynamically from
 * Ext.Direct back end.
 */
Ext.define('KitchenSink.view.direct.Tree', {
	...
	requires : ['KitchenSink.view.direct.TreeController'],

	// <example>
	exampleTitle : 'Ext.Direct Tree integration',
	exampleDescription : ['<p>This example shows how to load Tree nodes dynamically from a Direct proxy.</p>']
			.join(''),
