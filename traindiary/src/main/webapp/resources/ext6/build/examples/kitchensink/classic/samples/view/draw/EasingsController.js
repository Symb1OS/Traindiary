Ext.define('KitchenSink.view.draw.EasingsController', {
	...
	onSelect : function(combo, record) {
		var me = this, name = record.get('name'), sprite = me.sprite;
	...
	onAnimationEnd : function(fx) {
		var me = this, sprite = fx.getSprite();

		me.timeoutId = Ext.defer(function() {
					sprite.setAttributes({
								cy : sprite.attr.cy === me.cyEnd
										? me.cyStart
										: me.cyEnd
							});
				}, me.fxTime);
	...
	onAfterRender : function() {
		var me = this, easingsCombo = me.lookupReference('easings'), easingMap = Ext.draw.TimingFunctions.easingMap, draw = me
				.lookupReference('draw'), surface = draw.getSurface(), sprite = surface
				.getItems()[0], data = [], store, name, easing, record;
