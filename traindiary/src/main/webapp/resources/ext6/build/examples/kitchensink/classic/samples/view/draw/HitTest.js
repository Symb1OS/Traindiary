/**
 * This example shows how to hit test a path sprite. Move the pointer or tap
 * anywhere on the draw surface. If there's a sprite underneath it will be
 * highlighted.
 */
Ext.define('KitchenSink.view.draw.HitTest', {
	...
	requires : ['Ext.draw.Component', 'KitchenSink.view.HitTestComponent'],
