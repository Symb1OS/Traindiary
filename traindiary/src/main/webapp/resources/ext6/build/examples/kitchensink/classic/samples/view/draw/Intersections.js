/**
 * This example shows how to detect path sprite intersections. Click and drag a
 * path or shape and move it over another path or shape to see the points where
 * paths intersect.
 */
Ext.define('KitchenSink.view.draw.Intersections', {
	...
	requires : ['Ext.draw.Component', 'KitchenSink.view.IntersectionsComponent'],
