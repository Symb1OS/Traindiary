Ext.define('KitchenSink.view.IntersectionsComponent', {
	...
	onMouseDown : function(e) {
		var me = this, surface = me.getSurface(), sprites = surface.getItems(), xy = surface
				.getEventXY(e), x = xy[0], y = xy[1], target;
	...
	onMouseMove : function(e) {
		var me = this, surface = me.getSurface(), sprites = surface.getItems(), xy = surface
				.getEventXY(e), intersections = [], x = xy[0], y = xy[1], deltaX, deltaY, sprite, target, points, i, ln;
	...
	onMouseUp : function(e) {
		var me = this, surface = me.getSurface();
