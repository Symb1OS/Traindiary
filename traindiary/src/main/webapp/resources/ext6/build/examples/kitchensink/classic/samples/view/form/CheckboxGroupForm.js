/**
 * This example demonstrates the flexible layout capabilities of the
 * CheckboxGroup class. It also shows that you can validate checkboxes as a
 * group - try submitting the form before changing any values to see this.
 */
Ext.define('KitchenSink.view.form.CheckboxGroupForm', {
	...
	items : [{
				...
				// Using checkbox/radio groups will generally be more convenient
				// and flexible than
				// using individual checkbox and radio controls, but this shows
				// that you can
				...
				items : [{
							...
							// Use the default, automatic layout to distribute
							// the controls evenly
							// across a single row
							xtype : 'checkboxgroup',
							...
							cls : 'x-check-group-alt',
							// Distribute controls across 3 even columns,
							// filling each row
							...
							// Distribute controls across 3 even columns,
							// filling each column
							// from top to bottom before starting the next
							// column
							columns : 3,
							vertical : true,
							items : [{
							...
							cls : 'x-check-group-alt',
							// Specify exact column widths (could also include
							// float values for %)
							columns : [100, 100],
							vertical : true,
							items : [{
							...
							// and include any nested
							// container structure, for complete layout control.
							// In this example we only
							// want one item in the middle column, which would
							// not be possible using the
							// default 'checkboxgroup' layout's columns config.
							// We also want to put
