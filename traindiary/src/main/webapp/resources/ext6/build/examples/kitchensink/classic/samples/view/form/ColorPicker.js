 ...
 * 
 * The "colorbutton" is a small color swatch in the panel header. This displays
 * the color as a small swatch and on click shows the "colorselector". This
 * window also has the "colorselector" as a hidden item that is revealed by
 * pressing the "More" button.
 * 
 * The "colorfield" is a combobox-like picker that shows the color as a swatch
 * and hex value.
 */
