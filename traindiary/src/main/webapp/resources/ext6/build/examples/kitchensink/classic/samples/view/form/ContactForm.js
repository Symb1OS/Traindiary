/**
 * This shows an example of a common "Contact Us" form in a popup window. The
 * form uses vbox and hbox layouts to achieve a uniform flexible layout even
 * when the window is resized.
 * 
 * Note that Tab based navigation within the modal window is confined to within
 * the window.
 */
Ext.define('KitchenSink.view.form.ContactForm', {
			...
			// <example>
			requires : ['KitchenSink.view.form.ContactFormController',
