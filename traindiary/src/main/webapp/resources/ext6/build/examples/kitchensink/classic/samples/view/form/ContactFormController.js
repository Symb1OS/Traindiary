Ext.define('KitchenSink.view.form.ContactFormController', {
	...
	showWindow : function() {
		...
		if (!win) {
			...
			// A Window is a floating component, so by default it is not
			// connected
			// to our main View in any way. By adding it, we are creating this
			// link
	...
	onFormSubmit : function() {
		var formPanel = this.lookupReference('windowForm'), form = formPanel
				.getForm();
