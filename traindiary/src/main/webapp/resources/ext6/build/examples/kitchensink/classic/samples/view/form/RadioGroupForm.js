/**
 * This example demonstrates the flexible layout capabilities of the RadioGroup
 * class. It also shows that you can validate radios as a group - try submitting
 * the form before changing any values to see this.
 */
Ext.define('KitchenSink.view.form.RadioGroupForm', {
	...
	items : [{
				...
				// checkbox ones
				// above, so the comments will not be repeated. Please see
				// comments above for
				// additional explanation on some config options.
				xtype : 'fieldset',
				title : 'Radio Groups',
				// in this section we use the form layout that will aggregate
				// all of the fields
