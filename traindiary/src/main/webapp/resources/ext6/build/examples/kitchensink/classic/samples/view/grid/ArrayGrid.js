/**
 * This example shows how to create a grid from Array data. The grid is stateful
 * so you can move or hide columns, reload the page, and come back to the grid
 * in the same state you left it in.
 * 
					...
					renderer : function(val) {
						...
						if (val > 0) {
							return '<span style="color:'
									+ this.profileInfo.green + ';">' + out
									+ '</span>';
						} else if (val < 0) {
							return '<span style="color:' + this.profileInfo.red
									+ ';">' + out + '</span>';
						}
						return out;
					},
