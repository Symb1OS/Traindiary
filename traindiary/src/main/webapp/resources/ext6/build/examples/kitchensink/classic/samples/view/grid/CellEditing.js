/**
 * This example shows how to enable users to edit the contents of a grid. Note
 * that cell editing is not recommeded on keyboardless touch devices.
 */
Ext.define('KitchenSink.view.grid.CellEditing', {
	extend : 'Ext.grid.Panel',

	requires : ['Ext.selection.CellModel', 'Ext.grid.*', 'Ext.data.*',
			'Ext.util.*', 'Ext.form.*', 'KitchenSink.model.grid.Plant'],
	xtype : 'cell-editing',
		...
		Ext.apply(this, {
			...
			store : new Ext.data.Store({
						...
						proxy : {
							...
							// specify a XmlReader (coincides with the XML
