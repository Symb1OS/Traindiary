Ext.define('KitchenSink.view.grid.FramingButtons', {
	...
	// This view acts as the default listener scope for listeners declared
	// within it.
	// For example the selectionModel's selectionchange listener resolves to
	// this.
	defaultListenerScope : true,

	// This view acts as a reference holder for all components below it which
	// have a reference config
	// For example the onSelectionChange listener accesses a button using its
	// reference
	...
	dockedItems : [{
				...
				items : [{
							...
							reference : 'removeButton', // The referenceHolder
														// can access this
														// button by this name
