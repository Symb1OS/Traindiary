/**
 * This example shows how to create a property grid from an object. It also
 * demonstrates updating the grid with new values and also a whole new dataset.
 */
Ext.define('KitchenSink.view.grid.PropertyGrid', {
			extend : 'Ext.container.Container',

			// <example>
			requires : ['Ext.button.Button', 'Ext.grid.property.*',
