 ...
 * 
 * Supported features:
 *  - Single / Range / Multiple individual row selection. - Single / Range cell
 * selection. - Column selection by click selecting column headers. - Select /
 * deselect all by clicking in the top-left, header. - Adds row number column to
 * enable row selection. - Selection extensibility using a drag gesture.
 * Configured in this case to be up or down.
 * 
...
Ext.define('KitchenSink.view.grid.SpreadsheetChecked', {
	...
	requires : ['Ext.grid.selection.SpreadsheetModel',
			'Ext.grid.plugin.Clipboard', 'KitchenSink.store.grid.MonthlySales'],
	// <example>
	...
	selModel : {
		type : 'spreadsheet',
		// Disables sorting by header click, though it will be still available
		// via menu
		columnSelect : true,
		checkboxSelect : true,
		pruneRemoved : false,
