/**
 * This example shows how to create Widgets in grid columns. Widgets are
 * lightweight components with a simpler lifecycle.
 */
Ext.define('KitchenSink.view.grid.WidgetGrid', {
			extend : 'Ext.grid.Panel',
			requires : ['Ext.grid.column.Action', 'Ext.ProgressBarWidget',
					'Ext.slider.Widget', 'Ext.sparkline.*'],
			xtype : 'widget-grid',
			store : 'Widgets',
			collapsible : true,
			height : 350,
				...
				me.columns = [{
					...
					widget : {
						...
						handler : function(btn) {
							...
							Ext.Msg.alert("Button clicked", "Hey! "
											+ rec.get('name'));
						}
					}
				}, {
					...
					widget : {
						...
						listeners : {
							change : function(slider, value) {
								...
								// If the widget has been decorated by the
								// WidgetColumn with context-returning methods
								// then extract data and update its context
								// record.
