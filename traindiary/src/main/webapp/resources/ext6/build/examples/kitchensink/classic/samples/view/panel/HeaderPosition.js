/**
 * Panel headers can be docked to any side of the panel. This example
 * demonstrates how to dynamically change the position of a panel header by
 * binding the headerPosition config to the value of a segmented button.
 */
