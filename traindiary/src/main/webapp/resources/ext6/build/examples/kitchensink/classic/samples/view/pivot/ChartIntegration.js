/**
 * 
 * This example shows how to create a pivot grid and integrate it with Sencha
 * Charts.
 * 
 */
Ext.define('KitchenSink.view.pivot.ChartIntegration', {
	...
	items : [{
				...
				// Configure the left axis dimensions that will be used to
				...
				// Configure the top axis dimensions that will be used to
