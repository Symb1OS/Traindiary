/**
 * 
 * This example shows how to create a pivot grid and display the results in a
 * compact layout.
 * 
 */
Ext.define('KitchenSink.view.pivot.LayoutCompact', {
			...
			// Set this to false if multiple dimensions are configured on
			// topAxis and
			// you want to automatically expand the col groups when calculations
			// are ready.
			...
			// the columns.
			// When columns are generated the aggregate dimensions are also
			// used. If multiple aggregation dimensions
			// are defined then each top axis result will have in the end a
