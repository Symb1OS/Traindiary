/**
 * 
 * This example shows how to create a pivot grid and display the results in an
 * outline layout.
 * 
 */
Ext.define('KitchenSink.view.pivot.LayoutOutline', {
			...
			requires : ['KitchenSink.store.pivot.Sales',
			...
			// Set this to false if multiple dimensions are configured on
			// leftAxis and
			// you want to automatically expand the row groups when calculations
			// are ready.
