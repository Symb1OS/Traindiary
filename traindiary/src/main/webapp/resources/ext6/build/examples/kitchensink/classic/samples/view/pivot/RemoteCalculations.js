/**
 * 
 * This example shows how to create a pivot grid and do the calculations
 * remotely.
 * 
 * 
 */
Ext.define('KitchenSink.view.pivot.RemoteCalculations', {
	...
	requires : ['KitchenSink.view.pivot.RemoteCalculationsController'],
	...
	aggregate : [{
				// id was provided for a better understanding of the JSON
				// response
				id : 'valueAgg',
				dataIndex : 'value',
				header : 'Sum of value',
	...
	// Configure the left axis dimensions that will be used to generate the grid
	// rows
	leftAxis : [{
				// id was provided for a better understanding of the JSON
				// response
