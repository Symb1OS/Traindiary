Ext.define('KitchenSink.view.tab.AdvancedTabsController', {
	...
	onAddTabClick : function() {
		var tabPanel = this.lookupReference('tabpanel'), counter = ++this.counter, html = counter
				% 2
				? KitchenSink.DummyText.longText
				: KitchenSink.DummyText.extraLongText, tab = tabPanel.add({
					title : 'Tab ' + counter,
					html : html
				});
	...
	doCycle : function() {
		var rotation = this.rotation = (++this.rotation % 4), position = this.position;
