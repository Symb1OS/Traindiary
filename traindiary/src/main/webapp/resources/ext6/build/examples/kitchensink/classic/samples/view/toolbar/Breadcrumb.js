/**
 * Demonstrates a breadcrumb toolbar. A breadcrumb component is just another way
 * of navigating hierarchical data structures. It is bound to a standard tree
 * store and allows the user to set the selected node by clicking on the
 * navigation buttons.
 */
Ext.define('KitchenSink.view.toolbar.Breadcrumb', {
	...
	initComponent : function() {
		...
		// <example>
		// TODO: when using KitchenSink.store.Files(), nodes with children (e.g.
		// app, or button)
		// will return false when hasChildNodes() is called. When using the
		// exact
		// same data inline, the problem does not occur. Remove this workaround
		// when fixed.
