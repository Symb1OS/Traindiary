 ...
 * tree.
 * 
 * This tree is loaded using a linear sequence of records which look just like
 * the data for a regular store. The tree structure is imposed by use of a
 * parentId property in the node's data.
 * 
