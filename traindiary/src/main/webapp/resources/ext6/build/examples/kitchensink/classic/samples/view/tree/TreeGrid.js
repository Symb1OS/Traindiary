 ...
 *  - Multiple headers - Preloading of nodes with a single AJAX request - Header
 * hiding, showing, reordering and resizing - useArrows configuration - Keyboard
 * Navigation - Discontiguous selection by holding the CTRL key - Using custom
 * iconCls - singleExpand has been set to true
 */
	...
	initComponent : function() {
		...
		Ext.apply(this, {
			...
			columns : [{
						...
						// we must use the templateheader component so we can
						// use a custom tpl
