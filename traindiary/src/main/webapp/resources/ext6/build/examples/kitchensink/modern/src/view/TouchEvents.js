/**
 * Presents a large touch zone and reports all of the touch events fired when
...
Ext.define('KitchenSink.view.TouchEvents', {
			...
			requires : ['KitchenSink.view.touchevent.Info',
			...
			initialize : function() {
				...
				var padElement = Ext.get('touchpad'), fn = 'onTouchPadEvent';
