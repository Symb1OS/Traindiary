Ext.define('KitchenSink.view.touchevent.Logger', {
	...
	/**
	 * Adds a log message to the scrollable logging area, scrolls down to ensure
	 ...
	 */
	addLog : function(log) {
		var logger = Ext.getCmp('logger'), scroller = logger.getScrollable();
